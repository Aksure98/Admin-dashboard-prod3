...
interface ViewDriverTransactionProps {
  isOpen: boolean;
  onClose: () => void;
  transaction: DriverTransaction;
}

const ViewDriverTransaction = ({
  isOpen,
  onClose,
  transaction,
}: ViewDriverTransactionProps) => {
          ...
          <div className="bg-grey-50 rounded-2xl py-3 px-5 flex flex-col gap-3 ">
            ...
            <div className="flex justify-between">
              ...
              <div className="flex gap-1 items-center">
                ...
                <Link href={`/drivers/${transaction?.id}`}>
...
export default ViewDriverTransaction;
