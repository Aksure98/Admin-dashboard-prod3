...
// import AddDriverDocument from "./add-document";
import ViewDriverDocument from "./view-document";
import { useDriversDocument } from "@/hooks/drivers/getDriverDocument";
...
// import { allDrivers } from "../drivers-data";
...
export default function DriverDocumentsPage() {
  ...
  const { data: documentData, isLoading } = useDriversDocument({
    page: currentPage,
  ...
  const handleApplyBulkAction = () => {
    // Placeholder to hook into real bulk actions later
    // e.g. approve / reject multiple documents
  ...
  const columns = [
    ...
    {
      header: "Document",
      accessor: "type" as keyof DocumentItem,
      render: (row: DocumentItem) => <p>{row?.type}</p>,
    },
