...
import { useGetCargoVehicle } from "@/hooks/cargo/getVehicle";
import { useEditCargoVehicle } from "@/hooks/cargo/editVehicle";
...
const ManageVehicleModal: React.FC<ManageVehicleModalProps> = ({
  ...
  const { data: vehicleData } = useGetCargoVehicle(id);
  const editVehicleMutation = useEditCargoVehicle(id);
