...
import { type Operator } from "../operators-data";
...
import { OperatorDetail } from "@/@types";
...
interface OperatorDetailsProps {
  ...
  allDocuments: OperatorDetail[];
  operator: Operator;
}

// Verification display is handled elsewhere for now
...
const Details: React.FC<OperatorDetailsProps> = ({
  allDocuments,
  operator,
}) => {
  ...
  const columns = [
    {
      header: "Name",
      sortable: false,
      accessor: "name" as keyof OperatorDetail,
    },
    {
      header: "Image",
      sortable: false,
      accessor: "document" as keyof OperatorDetail,
      render: (row: OperatorDetail) => (
    ...
    },
    {
      ...
      sortable: false,
      accessor: "documentNumber" as keyof OperatorDetail,
    },
    {
      header: "Expires At",
      sortable: false,
      accessor: "expiresAt" as keyof OperatorDetail,
      render: () => <span>15 May 2026</span>,
    },
    {
      header: "Verification",
      sortable: false,
      accessor: "verification" as keyof OperatorDetail,
      render: () => (
    ...
    {
      header: "Actions",
      accessor: "id" as keyof OperatorDetail,
      sortable: false,
      render: () => (
        <div className="flex gap-2">
          <Link href={`/operators/documents`}>
