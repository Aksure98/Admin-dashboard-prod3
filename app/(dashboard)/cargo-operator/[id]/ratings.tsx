...
import { useGetCargoPerformance } from "@/hooks/cargo/getPerformance";
import { useState } from "react";

interface CargoRatingProps {
  id: string;
}
const CargoRatingDetails: React.FC<CargoRatingProps> = ({ id }) => {
  const [selectedTab, setSelectedTab] = useState("received");
  const { data: performanceData } = useGetCargoPerformance(id);
...
export default CargoRatingDetails;
