...
import { useGetCargoNotification } from "@/hooks/cargo/getCargoNotification";
import { ComposeNotificationsProps, DriverNotificationItem } from "@/@types";
import { useAddCargoNotification } from "@/hooks/cargo/addNotification";
...
const CargoNotifications = () => {
  ...
  const { mutateAsync: sendNotification, isPending: isSending } =
    useAddCargoNotification();

  const { data: notificationData } = useGetCargoNotification({
    page: currentPage,
...
export default CargoNotifications;
