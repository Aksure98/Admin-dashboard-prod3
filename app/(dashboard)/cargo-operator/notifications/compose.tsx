...
const ComposeNotifications = ({
  ...
  const recipientsOptions = useMemo(
    () => [
      { value: "all", label: "All Cargo Drivers" },
      { value: "active", label: "Active Cargo Drivers" },
      { value: "verified", label: "Verified Cargo Drivers" },
      { value: "unverified", label: "Unverified Cargo Drivers" },
      { value: "suspended", label: "Suspended Cargo Drivers" },
      { value: "by_state", label: "By State" },
      { value: "individual", label: "Individual Cargo Driver" },
    ],
    [],
  );
