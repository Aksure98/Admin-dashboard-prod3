...
import { useGetTowPerformance } from "@/hooks/tow/getPerformance";
import { useState } from "react";

interface TowRatingProps {
  id: string;
}
const TowRatingDetails: React.FC<TowRatingProps> = ({ id }) => {
  const [selectedTab, setSelectedTab] = useState("received");
  const { data: performanceData } = useGetTowPerformance(id);
...
export default TowRatingDetails;
