...
const ComposeNotifications = ({
  ...
  const recipientsOptions = useMemo(
    () => [
      { value: "all", label: "All Tow Operators" },
      { value: "active", label: "Active Tow Operators" },
      { value: "verified", label: "Verified Tow Operators" },
      { value: "unverified", label: "Unverified Tow Operators" },
      { value: "suspended", label: "Suspended Tow Operators" },
      { value: "by_state", label: "By State" },
      { value: "individual", label: "Individual Tow Operator" },
    ],
    [],
  );
