...
import { useUpdateBookingFee } from "@/hooks/pricing/updateBookingFee";
...
const EditBookingFees = ({
  isOpen,
  onClose,
  distanceId,
  currentAmount,
}: EditBaseFareFormProps) => {
  const editBaseFareMutation = useUpdateBookingFee();
...
export default EditBookingFees;
