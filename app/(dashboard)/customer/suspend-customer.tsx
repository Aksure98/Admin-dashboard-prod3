...
type SuspendAccountFormValues = z.infer<typeof SuspendAccountSchema>;
...
const SuspendAccountModal = ({
  ...
  const {
    ...
    formState: { errors },
    reset,
  } = useForm<SuspendAccountFormValues>({
    resolver: zodResolver(SuspendAccountSchema),
  });

  const handleSuspendAccount = async (data: SuspendAccountFormValues) => {
