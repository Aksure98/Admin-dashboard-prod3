...
const RidesDetails = () => {
  ...
  const handleOpenForceEndModal = () => setOpenForceEndModal(true);
  const handleOpenReassignDriverModal = () => setOpenReassignDriverModal(true);
  const handleCloseForceEndModal = () => setOpenForceEndModal(false);
