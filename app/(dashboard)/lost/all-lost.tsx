...
import { AllLost, LostItem, LostItemsResponse } from "@/@types";
...
const AllLostDetails: React.FC<AllLostProps> = ({
  allLost,
  currentPage,
  totalItems,
  itemsPerPage,
  ...
  const paginatedData = allLost.map((item) => ({ ...item, id: item.id }));
