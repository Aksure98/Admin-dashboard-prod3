...
const CancelledCargoList: React.FC<AllTripsProps> = ({
  allTrips,
  currentPage,
  totalItems,
  itemsPerPage,
  ...
  const columns = [
    ...
    {
      header: "Cancelled At",
      accessor: "cancelled_at" as keyof TripsDetailsResponse,
      render: (row: TripsDetailsResponse) => (
        <span>{formatDate(row?.cancelled_at)}</span>
      ),
    },
    {
      header: "Actions",
...
export default CancelledCargoList;
