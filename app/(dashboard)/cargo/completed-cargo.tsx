...
const CompletedCargoList: React.FC<AllTripsProps> = ({
  allTrips,
  currentPage,
  totalItems,
  itemsPerPage,
  ...
  const columns = [
    ...
    {
      header: "Trip Started at",
      accessor: "trip_started_at" as keyof TripsDetailsResponse,
      render: (row: TripsDetailsResponse) => (
        <span>{formatDate(row?.trip_started_at)}</span>
      ),
    },
    {
      header: "Trip Completed at",
      accessor: "trip_completed_at" as keyof TripsDetailsResponse,
      render: (row: TripsDetailsResponse) => (
        <span>{formatDate(row?.trip_completed_at)}</span>
      ),
    },
    {
      header: "Actions",
...
export default CompletedCargoList;
